...
_EXTERN_ long N_STAR_DIM, N_STAR_DIM_OPT, N_BIN_DIM, N_BIN_DIM_OPT, T_MAX_COUNT, MASS_PC_COUNT, STELLAR_EVOLUTION, TIDAL_TREATMENT, SS_COLLISION, TIDAL_CAPTURE, BH_CAPTURE, TC_POLYTROPE, STAR_AGING_SCHEME, PREAGING, NO_MASS_BINS, NO_BSE_NATAL_KICK_ARRAY, NO_BSE_FPRIMC_ARRAY, NO_BSE_QCRIT_ARRAY, STELLAR_ENGINE;
...
_EXTERN_ char *PATH_TO_TRACKS;
_EXTERN_ char *PATH_TO_HE_TRACKS;
...
_EXTERN_ FILE *binaryfile, *threebbfile, *threebbprobabilityfile, *lightcollisionfile, *threebbdebugfile, *binintfile, *collisionfile, *pulsarfile, *morepulsarfile, *newnsfile, *morecollfile, *triplefile, *tidalcapturefile, *tdefile, *semergedisruptfile, *removestarfile, *relaxationfile;
...
* @brief MPI: String buffers to store intermediate data that is finally flush out to files using MPI-IO
*/
_EXTERN_ char *mpi_bhsummaryfile_buf, *mpi_escbhsummaryfile_buf, *mpi_newbhfile_buf, *mpi_bhmergerfile_buf, *mpi_threebbfile_buf, *mpi_threebbprobabilityfile_buf, *mpi_lightcollisionfile_buf, *mpi_threebbdebugfile_buf;

/**
* @brief MPI: String buffers to store intermediate data that is finally flush out to files using MPI-IO
*/
_EXTERN_ char *mpi_bhsummaryfile_wrbuf, *mpi_escbhsummaryfile_wrbuf, *mpi_newbhfile_wrbuf, *mpi_bhmergerfile_wrbuf, *mpi_threebbfile_wrbuf, *mpi_threebbprobabilityfile_wrbuf, *mpi_lightcollisionfile_wrbuf, *mpi_threebbdebugfile_wrbuf;
